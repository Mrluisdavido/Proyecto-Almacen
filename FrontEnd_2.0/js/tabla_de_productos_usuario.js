...
let opcion = ''
//boton de crear va aqui ubicado //
        ...
        success: (res) => {
            ...
            res.forEach((productos) => {
                resultados += `<tr>
                        ...
                        <td class="text-center" width="20%"><a class="btnEditar btn btn-primary">salida</a></td>
                        </tr>`
            });
...
formProductos.addEventListener('submit', (e) => {
    if (cantidadProducto.value > nuevacantidadProducto.value) {
    e.preventDefault()
